...
if [[ ! -f "$dataset_dir/openpcdet/v1.0-mini/nuscenes_infos_${max_sweeps}sweeps_train.pkl" ]]; then
  echo "Temporal nuScenes infos are missing. Run prepare_nuscenes_temporal.sh first." >&2
  exit 1
fi
